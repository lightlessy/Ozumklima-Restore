...
<tr><td><b>Firma Adı:</b> </td><td><input type="text" name="firma"   value="<%=object("firma")%>" size="55"></td></tr>

<tr><td colspan=2 bgcolor="#4D4D4D" style="color:#FFFFFF"> İletişim Bilgileri </td></tr>
...
<tr bgcolor="#F0F0E8"><td><b>İletişim Formu Maillerini Almak İstediğiniz Mail Adresi:</b> </td><td><input type="text" name="formail"   value="<%=object("formail")%>" size="55"></td></tr>

<tr><td colspan=2 bgcolor="#4D4D4D" style="color:#FFFFFF"> Giriş Bilgileri </td></tr>

<tr bgcolor="#E7EEF1"><td><b>Kullanıcı Adı:</b> </td><td><input type="text" name="kullanici"   value="<%=object("kullanici")%>" size="55"></td></tr>
<tr bgcolor="#E7EEF1"><td><b>Şifre:</b> </td><td><input type="text" name="sifre"   value="<%=object("sifre")%>" size="55"></td></tr>
