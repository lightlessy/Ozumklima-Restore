...
<font class="font" style="color:#E10000; font-size:15px"> SIRALAMAYI DEĞİŞTİRMEK İÇİN RESMİ SÜRÜKLEYİP BIRAKINIZ.       </font>
 <BR><BR>
...
&nbsp;&nbsp;
 <a href="sil_galfoto.asp?id=<%=object("id")%>&gal_kat=<%=object("gal_kat")%>&altkat=<%=request("altkat")%>" title="Foto Sil" onclick="return confirm('Kayıt silinecek. Onaylıyor Musunuz?')"><img src="images/del.png" width=25></a>
