...
<!--#INCLUDE file="menu.asp"-->
 ...
 <div class="baslik">İçerik Düzenle</div>
...
<option  value="2"  <% if object("ana")=2 then %> selected <% end if %> >Yardım</option>
</select>
...
<tr> <td><b>Sayfa Adı:</b> </td><td><input type="text" name="isim"   value="<%=object("isim")%>" size="55"></td></tr>
...
<tr><td align=left colspan=2> <B>Sıralama:</B> &nbsp;&nbsp; <input type="text" size=3 name="sira" value="<%=object("sira")%>" onkeypress="return numbersonly(this, event)">       </td></tr>

<tr><td colspan=2><B>Yayın:</B> <input type="checkbox" name="yayin"  value="1" <% if object("yayin")="1" then %> checked <% end if %>></td></tr>
...
<input type="image" src="images/del.png"  onclick="return confirm('Sayfayı Silmek İstiyor Musunuz?')"></td></form>
