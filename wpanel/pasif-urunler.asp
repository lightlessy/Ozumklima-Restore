...
rSQL = "Select AffiliateID,anagrup,isim,urunana,tip, yayin from products  where anagrup="& mods1("id") &" and yayin=0 group by anagrup, isim, AffiliateID,urunana,tip, yayin"
