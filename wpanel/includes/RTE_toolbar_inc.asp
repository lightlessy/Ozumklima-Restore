...
'------------
If blnPrint OR blnPreview OR (blnSpellCheck AND RTEenabled = "winIE") OR blnHTMLView Then Response.Write(vbCrLf & "	document.writeln('<img src=""" & strRTEImagePath & "toolbar_separator.gif"" align=""absmiddle"" />")
...
'Spell check button
If blnSpellCheck AND RTEenabled = "winIE" Then Response.Write("<img src=""" & strRTEImagePath & "post_button_spell_check.gif"" align=""absmiddle"" border=""0"" onClick=""checkspell()"" title=""" & strTxtstrSpellCheck & """ class=""WebWizRTEbutton"" onmouseover=""overIcon(this)"" onmouseout=""outIcon(this)"" id=""spellboundSC"" />")
...
If blnAdvAdddHyperlink Then
	Response.Write("<img src=""" & strRTEImagePath & "post_button_hyperlink.gif"" align=""absmiddle"" border=""0"" onClick=""winOpener(\'RTE_popup_link.asp\',\'link\',0,0,520,374)"" title=""" & strTxtAddHyperlink & """ class=""WebWizRTEbutton"" onmouseover=""overIcon(this)"" onmouseout=""outIcon(this)"" />")
...
End If
If blnAttachments Then Response.Write("   <img src=""" & strRTEImagePath & "post_button_file_upload.gif"" align=""absmiddle"" onClick=""winOpener(\'RTE_popup_file_atch.asp\',\'files\',0,0,775,404)"" title=""" & strTxtFileUpload & """ border=""0"" class=""WebWizRTEbutton"" onmouseover=""overIcon(this)"" onmouseout=""outIcon(this)"" />")
'Popup window for images
If blnAdvAddImage Then
	Response.Write("<img src=""" & strRTEImagePath & "post_button_image.gif"" align=""absmiddle"" border=""0"" onClick=""winOpener(\'RTE_popup_adv_image.asp\',\'insertImg\',0,0,775,402)"" title=""" & strTxtAddImage & """ class=""WebWizRTEbutton"" onmouseover=""overIcon(this)"" onmouseout=""outIcon(this)"" />")
...
If blnSpecialCharacters Then Response.Write("<img src=""" & strRTEImagePath & "post_button_sp_char.gif"" align=""absmiddle"" border=""0"" onClick=""winOpener(\'RTE_popup_special_characters.asp\',\'insertTable\',0,0,550,304)"" title=""" & strTxtSpecialCharacters & """ class=""WebWizRTEbutton"" onmouseover=""overIcon(this)"" onmouseout=""outIcon(this)"" />")
'Button Pop up for emoticons
If blnEmoticonPopUp Then Response.Write("<img src=""" & strRTEImagePath & "post_button_smiley.gif"" align=""absmiddle"" border=""0"" onClick=""winOpener(\'RTE_popup_emoticons.asp\',\'emot\',0,0,650,350)"" title=""" & strTxtEmoticons & """ class=""WebWizRTEbutton"" onmouseover=""overIcon(this)"" onmouseout=""outIcon(this)"" />")
...
'Font Style
If blnFontStyle Then Response.Write("<img id=""formatblock"" src=""" & strRTEImagePath & "post_button_format.gif"" align=""absmiddle"" border=""0"" title=""" & strTxtFontStyle & """ onClick=""FormatText(\'formatblock\', \'\')"" class=""WebWizRTEbutton"" />")
'Font Type
If blnFontType  Then Response.Write("<img id=""fontname"" src=""" & strRTEImagePath & "post_button_font.gif"" align=""absmiddle"" border=""0"" title=""" & strTxtFontTypes & """ onClick=""FormatText(\'fontname\', \'\')"" class=""WebWizRTEbutton"" />")
'Font Size
If blnFontSize  Then Response.Write("<img id=""fontsize"" src=""" & strRTEImagePath & "post_button_size.gif"" align=""absmiddle"" border=""0"" title=""" & strTxtFontSizes & """ onClick=""FormatText(\'fontsize\', \'\')"" class=""WebWizRTEbutton"" />")
...
If (RTEenabled = "Gecko" OR RTEenabled = "opera") AND blnTextBackgroundColour Then Response.Write("<img id=""hilitecolor"" src=""" & strRTEImagePath & "post_button_fill.gif"" align=""absmiddle"" border=""0"" title=""" & strTxtBackgroundColour & """ onClick=""FormatText(\'hilitecolor\', \'\')"" class=""WebWizRTEbutton"" onmouseover=""overIcon(this)"" onmouseout=""outIcon(this)"" />")
...
If blnAbout Then
	...
	Response.Write("<img src=""" & strRTEImagePath & "post_button_about.gif"" align=""absmiddle"" border=""0"" onClick=""winOpener(\'RTE_popup_about.asp\',\'about\',0,0,400,177)"" title=""" & strTxtAboutRichTextEditor & """ class=""WebWizRTEbutton"" onmouseover=""overIcon(this)"" onmouseout=""outIcon(this)"" />")
	Response.Write("');")
End If
%>