...
<tr><td width=240><font color=#000000><b>Sayfa Adı </td><td  colspan=3><input type="text" size="100" name="isim"></td></tr>	

<tr><td> <font color=#000000>  <b>İçerik </b>:</td><td colspan=3>     
...
%> 
 ...
 <tr><td><B>Yayın:</B> </td><td><input type="checkbox" name="yayin"  value="1"></td></tr>           
   
 <tr><td> <b>Sayfa Sıralama </b> </td><td><input type="text" size="3" name="sira" onkeypress="return numbersonly(this, event)" value="0"></td>	  
