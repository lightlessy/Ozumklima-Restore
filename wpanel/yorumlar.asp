...
<td align=center><font color=#FF0000><b>SİL</b></font></td></tr>      
...
<% if object("onay")=1 then %>  <B>Yayında</B> 
<% else %>
...
<input type="submit" value="SİL" name="delete" onclick="return confirm('Kayıt Silinecek. Onaylıyor musunuz?')"></td></form>
</div>        
...
<a href="?sayfa=1" title="İlk Sayfa"><font color=#4E4E4E>[««]</a>
