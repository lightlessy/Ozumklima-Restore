...
sonYeri=InStrRev(txt,"/") 'son / işaretini yeri  

sonuc=Mid(txt,sonYeri+1,Len(txt) )  'son / işretinden kalan yazının tamamı   



istekbolum = Split(sonuc,"-")  'tirelerden bölerek dizi oluştu  

uzunluk=uBound(istekbolum)     'tirelerden bölerek oluşturduğumuz dizinin uzunluğu    
...
<a href="http://www.ozumklima.com/urunler/<%=uruns("dokuman") %>" target=_Blank><div class="whats" style="color:#3A3A3A"><img src="images/ikon5.png" >  <div><b>Broşür İndir</B></div> </div></a> 
<% end if %>

<BR><BR><BR>  
  <input  type="submit" value="Ücretsiz Keşif" name="update" id="sbmt" class="sepete" style="background:#A3C225;color:#FFFFFF; font-family:Source Sans Pro; font-weight:bold; font-size:1.2em; padding: 12px 32px 12px 32px; -webkit-border-radius: 6px; -moz-border-radius: 6px; border-radius: 6px;  ">    
</form>
...
<div style="text-align:center">
  ...
  <form method="POST" action="iletisim.asp" name="myForm"  >   
            <input  type="submit" value="BU ÜRÜNLE İLGİLENİYORUM" name="update" id="sbmt" class="sepete" style="background:#A3C225;color:#FFFFFF; font-family:Source Sans Pro; font-weight:bold; font-size:1.2em; padding: 12px 32px 12px 32px; -webkit-border-radius: 6px; -moz-border-radius: 6px; border-radius: 6px;  ">    
</form>   
<BR><BR>&nbsp;                          
</div>
