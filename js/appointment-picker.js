...
(function (root, factory) {
	...
	var AppointmentPicker = function(el, options) {
		this.options = {
			...
			minTime: 8, // min pickable hour (1-24)
			maxTime: 17, // max pickable hour (1-24)
			startTime: 8, // min displayed hour (1-24)
			endTime: 17, // max displayed hour (1-24)
			...
			title: 'Randevu Saati' // Title in opened state
		};
		this.template = {
